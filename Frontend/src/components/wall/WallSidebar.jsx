...
const WallSidebar = ({
  ...
  return (
    <aside
      className={`wall-sidebar sidebar-container floating-sidebar z-40 ${className || ''} flex flex-col w-full lg:w-[340px] bg-slate-900/95 border border-orange-500/30 shadow-2xl backdrop-blur-xl`}
      style={{
        background: 'linear-gradient(135deg, rgba(30,41,59,0.98) 0%, rgba(15,23,42,0.98) 100%)',
        backdropFilter: 'blur(20px)',
        border: '1px solid rgba(249,115,22,0.18)',
        boxShadow: '0 20px 25px -5px rgba(0,0,0,0.25),0 10px 10px -5px rgba(249,115,22,0.04),0 0 0 1px rgba(249,115,22,0.05),inset 0 1px 0 rgba(249,115,22,0.08)'
      }}
    >
      ...
      {!isViewOnly && (
        <div className="animate-fade-in-up delay-100 w-full overflow-x-auto">
          <div className="bg-slate-800/80 backdrop-blur rounded-2xl p-1 shadow-lg border border-orange-500/20 flex flex-row lg:grid lg:grid-cols-2 gap-1 w-max min-w-full">
            {TABS.map((tab, index) => (
              <button
                key={tab.key}
      ...
      {isViewOnly && (
        <div className="animate-fade-in-up delay-100">
          <div className="bg-slate-800/80 rounded-lg p-4 border border-orange-500/20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-semibold text-orange-300">View-Only Mode</h3>
            </div>
