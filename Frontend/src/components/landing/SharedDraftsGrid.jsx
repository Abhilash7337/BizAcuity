...
const SharedDraftCard = ({ draft, onOpenDraft, onRemoveClick, formatDate }) => {
  return (
    <div className="group bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 relative border border-orange-500/20 hover-lift animate-slide-in-up">
      ...
      <button
        ...
        className="absolute top-3 right-3 p-2 bg-slate-700/90 backdrop-blur-sm rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-red-900/50 z-10 transform scale-90 group-hover:scale-100"
      >
      ...
      <div className="h-32 bg-gradient-to-br from-slate-700 to-slate-600 relative overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute top-3 left-3 w-8 h-6 bg-slate-300 border border-orange-500 rounded shadow-sm transform rotate-6"></div>
          <div className="absolute top-2 right-5 w-6 h-8 bg-slate-300 border border-orange-500 rounded shadow-sm transform -rotate-12"></div>
          <div className="absolute bottom-3 left-5 w-10 h-6 bg-slate-300 border border-orange-400 rounded shadow-sm transform -rotate-3"></div>
          <div className="absolute bottom-2 right-3 w-7 h-7 bg-slate-300 border border-orange-500 rounded shadow-sm transform rotate-12"></div>
        </div>
  ...
  return (
    <div className="col-span-full">
      <div className="bg-slate-800/90 backdrop-blur-sm rounded-2xl p-12 text-center shadow-lg border border-orange-500/20 hover-lift">
        ...
        <h3 className="text-2xl font-bold text-orange-400 mb-3">No shared designs yet</h3>
        <p className="text-slate-400 max-w-md mx-auto">Designs shared with you by other users will appear here</p>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="col-span-full text-center py-16">
      <div className="relative">
        <div className="animate-spin rounded-full h-16 w-16 border-4 border-slate-600 border-t-orange-500 mx-auto"></div>
        <div className="mt-4 text-orange-400 font-medium">{message}</div>
      </div>
    </div>
  );
};
      ...
      <div className="p-6">
        ...
        <div className="mb-2">
          <input
            ...
            readOnly
            className="w-full text-xs bg-slate-700 text-slate-300 rounded px-2 py-1 border border-slate-600 focus:outline-none focus:ring-2 focus:ring-orange-400"
        ...
        <button
          onClick={() => onRevokeClick(draft)}
          className="w-full bg-red-900/20 hover:bg-red-900/30 text-red-400 font-semibold py-2 px-4 rounded-xl shadow-sm mt-1 transition-colors duration-200 border border-red-500/30"
        >
          Revoke Link
        </button>
      </div>
