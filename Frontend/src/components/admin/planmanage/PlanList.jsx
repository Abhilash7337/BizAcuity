              ...
              >
                ...
                <td className="px-6 py-4">
                  <div className="text-sm text-slate-300 max-w-xs">
                    ...
                    {plan.exportDrafts && (
                      <div className="mb-2">
                        <span className="flex items-center bg-green-500/20 text-green-300 px-2 py-1 rounded-lg text-xs border border-green-500/30 w-fit">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex gap-2">
                    ...
                    {(plan.isDeletable !== false && plan.isDefault !== true) && (
                      <button
                    ...
                    {(plan.isDeletable === false || plan.isDefault === true) && (
                      <span className="text-slate-500 font-medium px-3 py-1 rounded-lg bg-slate-600/30 text-xs">
                        System Plan
                      </span>
                    )}
                  </div>
