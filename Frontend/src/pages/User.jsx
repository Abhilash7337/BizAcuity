            ...
            <div className="bg-white rounded-3xl shadow-xl border border-orange-300/30 overflow-hidden animate-[cardFadeIn_0.8s_ease] relative">
              ...
              <div className="pt-8 pb-8 px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  ...
                  <div className="text-center">
                    <div className="w-16 h-16 mx-auto mb-3 bg-orange-400/20 rounded-2xl flex items-center justify-center">
                      <svg className="w-8 h-8 text-orange-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <div className="text-2xl font-bold text-orange-800">{userStats.photos}</div>
                    <div className="text-sm text-orange-600 font-medium">Photos</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-2xl font-bold text-orange-800">Pro</div>
